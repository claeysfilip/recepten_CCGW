...
function render() {
  ...
  filtered.forEach(recipe => {
    ...
    if (cardImg) attachImageFallback(cardImg);
...
function openDetail(recipe) {
  ...
  const detailImg = detailContent.querySelector('.detail-image');
  if (detailImg) attachImageFallback(detailImg);
  closeBtn.focus();
}
...
// Als een foto de eerste keer niet laadt (bv. wisselende verbinding),
// probeer het na een korte pauze nog één keer opnieuw. Lukt het dan nog
// niet, verberg de afbeelding netjes in plaats van een kapot icoontje te tonen.
